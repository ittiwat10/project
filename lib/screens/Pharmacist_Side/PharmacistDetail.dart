...
class PharmacistDetail extends StatefulWidget {
  const PharmacistDetail({super.key});

  @override
  State<PharmacistDetail> createState() => _PharmacistDetailState();
}

class _PharmacistDetailState extends State<PharmacistDetail> {
